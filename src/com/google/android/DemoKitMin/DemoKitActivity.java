...
public class DemoKitActivity extends Activity implements Runnable {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (getLastNonConfigurationInstance() != null) {
            Log.d(TAG, "getLastNonConfigurationInstance returned non-null");
			mAccessory = (UsbAccessory) getLastNonConfigurationInstance();
			openAccessory(mAccessory);
		} else {
            Log.d(TAG, "getLastNonConfigurationInstance returned null");
        }
        if (mAccessory != null) {
            Log.d(TAG, "mAccessory is non-null");
        } else {
	...
	public Object onRetainNonConfigurationInstance() {
		if (mAccessory != null) {
            Log.d(TAG, "onRetainNonConfigurationInstance found existing mAccessory");
			return mAccessory;
		} else {
            Log.d(TAG, "Calling super.onRetainNonConfigurationInstance");
            Object val = super.onRetainNonConfigurationInstance();
            if (val != null) {
                Log.d(TAG, "Got non-null result");
            } else {
                Log.d(TAG, "Got null result");
            }
            return val;
	...
	public void onResume() {
		...
		if (mInputStream != null && mOutputStream != null) {
            Log.d(TAG, "Found non-null mInputStream and mOutputStream");
			return;
		}

		UsbAccessory[] accessories = mUsbManager.getAccessoryList();
        if (accessories != null) {
            Log.d(TAG, "getAccessoryList returned non-null");
        } else {
            Log.d(TAG, "getAccessoryList returned null");
        }
        UsbAccessory accessory = (accessories == null ? null : accessories[0]);
		if (accessory != null) {
            Log.d(TAG, "Got non-null accessory");
			if (mUsbManager.hasPermission(accessory)) {
                Log.d(TAG, "hasPermission is true");
				openAccessory(accessory);
			} else {
                Log.d(TAG, "Checking for permission request");
				synchronized (mUsbReceiver) {
					if (!mPermissionRequestPending) {
                        Log.d(TAG, "Sending permission request");
	...
	private void openAccessory(UsbAccessory accessory) {
		...
		if (mFileDescriptor != null) {
            Log.d(TAG, "UsbManager openAccessory returned non-null");
